...
def get_metric_analysis_layout():
    return dbc.Container([
        ...
        # Subtitle with icons
        html.H5([
            "Exploring Global Health Trends and Patterns ",
            html.Span("🔬")
        ],
        ...
        dbc.Row([
            dbc.Col([
                html.H4("Average Prevalence Rate by Continent"),
                html.Label("Select Year:"),
                dcc.Dropdown(
                    id='prevalence-year-dropdown',
                    options=[{"label": str(year), "value": year}
                             for year in years],
                    value=years[0],
                    clearable=False
                ),
                dcc.Graph(id='prevalence-rate-continent')
            ], style=CARD_STYLE, width=12, lg=6, className="mb-4"),
            # Plot 2: Mortality Rate Over Time
            dbc.Col([
                html.H4("Mortality Rate Over Time"),
                ...
                html.Label("Select Age Group:", style={"marginTop": "10px"}),
                dcc.Dropdown(
        ...
        dbc.Row([
            dbc.Col([
                html.H4("Mortality Rate by Country & Gender"),
                html.Label("Select Country:"),
                dcc.Dropdown(
                    id='mortality-country-dropdown',
                    options=[{"label": country, "value": country}
                             for country in countries],
                    value=countries[0],
                    clearable=False
                ),
                html.Label("Select Gender:", style={"marginTop": "10px"}),
                dcc.Dropdown(
                    id='mortality-gender-dropdown',
        ...
        dbc.Row([
            dbc.Col([
                html.H4("Average Mortality Rate Per Country"),
                html.Label("Select Year:"),
                dcc.Dropdown(
                    id='average-mortality-year-dropdown',
                    options=[{"label": str(year), "value": year}
                             for year in years],
                    value=years[0],
                    clearable=False
        ...
        dbc.Row([
            dbc.Col([
                html.H4("Risk Factors Analysis by Continent"),
